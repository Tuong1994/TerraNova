const EngLang = {
  ...
  headerMenu: {
    ...
    mainboard: "MAINBOARD",
    mindsetProgramming: "Mindset Programming",
  ...
  productCarts: {
    ...
    choosePaymentType: "Choose your payment type",
  ...
  warranty: {
    // BANNER
    banner: {
      title: "WARRANTY POLICY AT TERRA NOVA",
      content_1:
        "If you have difficulty contacting the Warranty Center, please contact TERRA NOVA with the following information for support",
      content_2: "Hotline: 028 3975 3100",
    },
    // STEP
    step: {
      title: "PRODUCT WARRANTY STEP",
      note: "TERRA NOVA does not support home warranty, if you have warranty needs, please contact TERRA NOVA.",
      step_1: {
        title: "STEP 1",
        content:
          "When in need of product warranty, please contact TERRA through the following forms",
      ...
      step_2: {
        ...
        address_2:
          "Branches 2: 12B Nguyen Huu Canh Str, Ward 19, District Binh Thanh, HCMC",
        note: "TERRA NOVA staff will receive information and respond to the processing time with customers, according to the policy of each product.",
      },
      step_3: {
        title: "STEP 3",
        content:
    ...
    condition: {
      ...
      enough: {
        ...
        list_1:
          "Products and equipment provided by TERRA NOVA (based on sales invoice, stamp or warranty card, serial number, etc.).",
        list_2:
          "For products and equipment that are granted a warranty (PBH), the customer must present the PBH and have a full warranty stamp of TERRA NOVA (if the device does not issue a PBH, the TERRA NOVA stamp must be intact) and must be still intact. within the warranty period.",
        list_3:
      ...
      notEnough: {
        ...
        list_5:
          "No warranty for company promotional gifts. (Except SSD + RAM).",
        list_6:
    ...
    returns: {
      ...
      charge: {
        title:
          "Refunds will be made, but fees will apply in the following cases",
        list_1:
          "Charge 2% / on TERRA NOVA's returned product bill: the product is still within the return period and the device has not been used",
        list_2:
          "Charge 5%/ on returned product bill of TERRA NOVA: the product is still within the return period and the device is used",
        list_3:
          "Charge 10% / on the product bill paid by TERRA NOVA ( from the 8th to the 12th day ) . Including unused or used machines",
        list_4:
          "Charge 20% / on the product bill paid by TERRA NOVA ( from the 13th to the 20th day ) . Including unused or used machines",
        list_5:
          "From the date of delivery, after 20 days of purchase, the purchased product will not be eligible for TERRA NOVA's return policy.",
      },
      note: "NOTE – RETURN REQUIREMENT: Product must be intact, undamaged, undamaged. Stamps/labels on the machine are intact. It is mandatory to have all the documents - accessories included in the box and documents that TERRA NOVA has exported as when the customer receives the goods (including gifts). TERRA NOVA will refund at the latest within 48 hours in the form of cash or transfer at the request of the customer. TERRA NOVA will not apply the return policy if the product does not fully meet the above requirements",
    },
  },
  ...
  toastMessages: {
    ...
    error: {
      ...
      province: "You haven't choose province",
      district: "You haven't choose district",
      ward: "You haven't choose ward",
      product: "You haven't selected product",
