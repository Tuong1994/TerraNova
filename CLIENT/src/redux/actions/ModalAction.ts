...
interface OPEN_BOOKING_TICKET_MODAL {
  type: EModalActionTypes.OPEN_BOOKING_TICKET_MODAL;
}

interface OPEN_TIMEOUT_MODAL {
...
interface CLOSE_TRAILER_MODAL {
  type: EModalActionTypes.CLOSE_TRAILER_MODAL;
}

interface CLOSE_BOOKING_TICKET_MODAL {
  type: EModalActionTypes.CLOSE_BOOKING_TICKET_MODAL;
}

interface CLOSE_TIMEOUT_MODAL {
