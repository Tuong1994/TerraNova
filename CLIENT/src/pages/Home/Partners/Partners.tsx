...
const Partners: React.FunctionComponent = (props) => {
  const cardData = [
    ...
    },
    {
      id: 3,
      name: "MSI",
      imgSrc: "../img/msi-gaming_logo.jpg",
    ...
    },
    {
      id: 7,
      name: "VIEWSONIC",
      imgSrc: "../img/viewsonic-gaming_logo.jpg",
    ...
    },
    {
      id: 9,
      name: "SAMSUNG",
      imgSrc: "../img/samsung-galaxy_logo.jpg",
